...
public class Kelutral extends Activity implements OnClickListener, 
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		// Load a custom font for the Dictionary and Resource buttons
		...
		Button learnNaviOrgButton = findViewById(R.id.LearnNaviOrgButton);
		Button disclaimerButton = findViewById(R.id.DisclaimerButton);
		Button returnFromResourcesButton = findViewById(R.id.ReturnFromResourcesButton);
		Button returnFromAboutButton = findViewById(R.id.ReturnFromAboutButton);
		Button returnFromDisclaimerButton = findViewById(R.id.ReturnFromDisclaimerButton);
		TextView resourcesTextView = findViewById(R.id.ResourcesTextView);
		TextView aboutText = findViewById(R.id.AboutText);
		TextView disclaimerText = findViewById(R.id.DisclaimerText);
		dictionaryButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		resourcesButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		aboutButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		learnNaviOrgButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		disclaimerButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		returnFromResourcesButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		returnFromAboutButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		returnFromDisclaimerButton.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		resourcesTextView.setTypeface(Typeface.createFromAsset(getAssets(), "papyrus.ttf"));
		aboutText.setTypeface(Typeface.createFromAsset(getAssets(),"papyrus.ttf"));
		disclaimerText.setTypeface(Typeface.createFromAsset(getAssets(),"papyrus.ttf"));
    ...
    private void loadAnimations()
    {
		...
		fadeIn.setDuration(FLIPANIM_SPEED);

		fadeOut = new AlphaAnimation(1, 0);
		fadeOut.setInterpolator(new AccelerateInterpolator());
		fadeOut.setStartOffset(50);
		fadeOut.setDuration(FLIPANIM_SPEED);
    }
	...
	private void handleButtonClick(int id)
	{
		...
		case R.id.ResourcesButton:
			if (mAnimator.getDisplayedChild() != mMainIndex)
				break;
			// Flip from main page to resources
			// Back button to return to main page
			flipTo(mResourcesIndex);
			mBackAction = R.id.ReturnFromResourcesButton;
			break;
		...
		case R.id.ReturnFromResourcesButton:
			if (mAnimator.getDisplayedChild() != mResourcesIndex)
				break;
			// Flip from resources page to main page
